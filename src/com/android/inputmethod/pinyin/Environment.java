...
public class Environment {
     ...
     */
    private static final float NORMAL_KEY_TEXT_SIZE_RATIO = 0.075f / 2;// modify by ygli.

    /**
     * The text size for function keys. It is relative to the smaller one of
     * screen width and height.
     */
    private static final float FUNCTION_KEY_TEXT_SIZE_RATIO = 0.055f / 2; // modify by ygli.

    /**
     * The text size balloons of normal keys. It is relative to the smaller one
     * of screen width and height.
     */
    private static final float NORMAL_BALLOON_TEXT_SIZE_RATIO = 0.14f / 2; // modify by ygli.

    /**
     * The text size balloons of function keys. It is relative to the smaller
     * one of screen width and height.
     */
    private static final float FUNCTION_BALLOON_TEXT_SIZE_RATIO = 0.085f / 2;// modify by ygli.
